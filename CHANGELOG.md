...
- [BREAKING] Fix: [Issue: #256](https://github.com/maheshj01/searchfield/issues/256) Add `maintainLabelSize` and `enabled` to SearchInputDecoration (Requires Flutter 3.41.0 or greater)
