# [searchfield: ^0.7.7](https://pub.dev/packages/searchfield)
...
- `textCapitalization` : Configures how the platform keyboard will select an uppercase or lowercase keyboard. Defaults to `TextCapitalization.none`.
